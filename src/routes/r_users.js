...
// Post a user
router.post('/', authMiddleware.checkRole([2, 1]), upload.none(), usersController.postUser);
// Patch a User
router.patch('/:id', authMiddleware.checkRole([2, 1]), upload.none(), usersController.patchUser);
// Delete a user
